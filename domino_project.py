...
class Jugador(object):
    ...
    mostrar mano el cual muestra la mano del jugador con el method mostrar_Ficha de la class Ficha
...
class Mesa(Jugador):
    ...
    make_game() method: crea una variable en el diccionario self.juego que contiene las fichas y
    el nombre del jugador(toma el method tomar() de la class Jugador.
