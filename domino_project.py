...
class Ficha(object):
    ...
    """
    class que tiene una ficha de domino con sus dos valores
    con un method para mostrar esos valores
...
class Caja(object):
    ...
    class de una caja de domino con una list
    que se usa como caja para guardar las fichas con los methods:
...
class Jugador(object):
    ...
    class jugador
    contiene el nombre y la mano del jugador con el method tomar()
    el cual toma una ficha de la caja y
    mostrar mano el cual muestra la mano del jugador
    con el method mostrar_Ficha de la class Ficha
...
class Mesa(Jugador):
    ...
    make_game() method: crea una variable en el diccionario self.juego
    que contiene las fichas y el nombre del jugador(toma el method tomar()
    de la class Jugador.
